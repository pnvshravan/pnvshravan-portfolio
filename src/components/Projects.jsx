    ...
    return (
        <> 
            <div className="h-auto min-h-[18rem] p-2 mob-sm:mb-6 tablet:pb-8 flex flex-col justify-center items-center">
                ...
                <div className="grid grid-cols-2 gap-16 w-[40rem] mob-sm:flex-col mob-sm:w-[20rem] mob-sm:items-center mob-sm:gap-8 tablet:flex-col tablet:w-[25rem] tablet:items-center tablet:gap-10">
                    ...
                    <div className="p-2 border-gray-300 border-2 w-[18rem]
                    rounded-md bg-gray-900 mob-sm:w-[15rem] tablet:w-[25rem]">
                        <h3 className="text-center">Postivius</h3>
                        <p className="mt-4"><i>(React, CSS3)</i></p>
                        <span className="inline-flex gap-2 mt-4 place-items-center">
                            Links: 
                            <a href="" target="_blank" className="hover:scale-125"><FaGithub size={20}/></a>
                        </span>
                    </div>
                </div> 
            </div>
